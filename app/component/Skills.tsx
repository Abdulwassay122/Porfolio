      ...
      <section id='skills' className=' py-10 bg-black '>
        ...
        <div className='md:w-[50%] w-[100%]   ' >
            ...
            <div className='flex  justify-center mt-10'>
              <div className='flex font-roboto justify-between w-[70%] items-center'>
        ...
        <div className='md:w-[50%] w-[100%] '>
            ...
            {/* <div className='flex  justify-center mt-10'>
              <div className='flex font-roboto justify-between w-[70%] items-center'>
                <p className='mx-2 my-1 flex font-kanit font-bold text-xl items-center gap-2'><img className='h-10' src={communication.src} alt="" /> Comunication</p>
                <p className='mx-2 my-1'>40%</p>
              </div>
            </div>
              <div className=' justify-center flex mb-10' >
                <span className='w-[70%] h-5  bg-gray-400 rounded-full'>
            ...
            {/* <div className='flex  justify-center mt-10'>
              <div className='flex font-roboto justify-between w-[70%] items-center'>
              <p className='mx-2 my-1 flex font-kanit font-bold text-xl items-center gap-2'><img className='h-10' src={research.src} alt="" /> Research</p>
              ...
              <div className=' justify-center flex mb-10' >
                ...
                {/*2 ------------------------------------------------ */}
            {/* <div className='flex  justify-center mt-10'>
              <div className='flex font-roboto justify-between w-[70%] item-center'>
                <p className='mx-2 my-1 flex font-kanit font-bold text-xl items-center gap-2'><img className='h-10' src={creativity.src} alt="" />Creativity</p>
                <p className='mx-2 my-1'>75%</p>
              </div>
            </div>
              <div className=' justify-center flex mb-10' >
            ...
            {/* <div className='flex  justify-center mt-10'>
              <div className='flex font-roboto justify-between w-[70%] items-center'>
                <p className='mx-2 my-1 flex font-kanit font-bold text-xl items-center gap-2'><img className='h-10 ' src={teamwork.src} alt="" />Team Work</p>
                <p className='mx-2 my-1'>60%</p>
              </div>
            </div>
              <div className=' justify-center flex mb-10' >
