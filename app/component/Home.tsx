    ...
    <>
      <section id='home' className='flex sm:flex-row  pt-10 pb-10 justify-between bg-black  '>
        <div className=' lg:mt-32  sm:mt-16  sm:ml-10 ml-5  md: mt-16 md:ml-20 animate-slideInLeft z-10 w-fit'>
          ...
          <div className='text-2xl md:text-3xl mt-5 w-fit font-sen font-semibold'>And I'm a <span className='text-red-400 border-solid border-r-4 pr-2 border-white'>Frontend Developer</span></div>
        ...
        <div ><Image className='hidden xl:block h-[600px] w-auto lg:block md:hidden   ' src={Pic} alt="Abdul Wassay Photo" /></div>
