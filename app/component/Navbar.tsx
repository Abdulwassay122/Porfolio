  ...
  return (
    ...
    <header className="h-[85px] overflow-hidden flex py-5 justify-between md:flex-row flex-col sticky top-0 z-20  bg-black ">
      ...
      <nav>
        ...
        <ul id='toggleMenu' className={`font-roboto md:flex-row mt-2.5  text-[20px] md:bg-black md:h-full bg-[#77effc] md:flex lg:mr-20 md:mr-6 flex-col md:w-full w-[150px] h-screen md:relative md:right-0 fixed  z-50 md:animate-none transition-right duration-300   ${menuOpen ? 'right-0':'right-[-150px]'}`}>
